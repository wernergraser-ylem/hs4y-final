...
/**
 * Class file
 * ContentCustomElement
 * Render a custom element from a content element
 */
class ContentCustomElement extends \Contao\ContentElement
{
	/**
	 * Template
	 * @var
	...
	public function generate()
	{
		...
		if ($request && System::getContainer()->get('contao.routing.scope_matcher')->isBackendRequest($request))
		{
			...
			if(!empty($this->objCE))
			{
				...
				$strWildcard = $objBackendHelper->generateBackendWildcard($this->objCE->get('id'),$intId,'tl_content');
			}
