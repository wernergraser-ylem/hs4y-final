 ...
 * Filters
 */
$GLOBALS['TL_LANG']['PCT_CUSTOMELEMENTS']['FILTERS']['customsql']		= array('Eigene SQL Abfrage','Filterung nach einer eigenen SQL-Abfrage, die in die WHERE Abfrage eingesetzt wird.');