 ...
 * Filters
 */
$GLOBALS['TL_LANG']['PCT_CUSTOMELEMENTS']['FILTERS']['timestamp'][0]	= 'Date-, Timestamp';
$GLOBALS['TL_LANG']['PCT_CUSTOMELEMENTS']['FILTERS']['timestamp'][1]	= 'Filters by a date/timestamp value.';