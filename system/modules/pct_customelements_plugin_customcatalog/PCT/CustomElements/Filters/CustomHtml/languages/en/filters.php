 ...
 * Filters
 */
$GLOBALS['TL_LANG']['PCT_CUSTOMELEMENTS']['FILTERS']['customhtml'][0]	= 'Custom HTML widget';
$GLOBALS['TL_LANG']['PCT_CUSTOMELEMENTS']['FILTERS']['customhtml'][1]	= 'Create custom filter fields';