 ...
 * Filters
 */
$GLOBALS['TL_LANG']['PCT_CUSTOMELEMENTS']['FILTERS']['selectdb'][0]		= 'Select-Database';
$GLOBALS['TL_LANG']['PCT_CUSTOMELEMENTS']['FILTERS']['selectdb'][1]		= 'Filters by the selected value';