 ...
 * Attributes
 */
$GLOBALS['TL_LANG']['PCT_CUSTOMELEMENTS']['ATTRIBUTES']['itemtemplate']		= array('Template-Auswahl','Dieses Attribute erstellt eine eigene Template-Auswahl für den Eintrag.');