 ...
 * Attributes
 */
$GLOBALS['TL_LANG']['PCT_CUSTOMELEMENTS']['ATTRIBUTES']['customelement']		= array('CustomElement Widget','Dieses Attribut integriert ein CustomElement Widget in den Eintrag.');