 ...
 * Attributes
 */
$GLOBALS['TL_LANG']['PCT_CUSTOMELEMENTS']['ATTRIBUTES']['selectdb']		= array('Auswahl-Datenbank, einfach (Select/Radio)','Dieses Attribut stellt Optionen aus einer Datenbanktabelle zur Auswahl.');