 ...
 * Attributes
 */
$GLOBALS['TL_LANG']['PCT_CUSTOMELEMENTS']['ATTRIBUTES']['alias']		= array('Alias','Der Alias ist eine eindeutige Referenz und wird anstelle der ID des Eintrags zum Generieren der Frontend-URL genutzt.');