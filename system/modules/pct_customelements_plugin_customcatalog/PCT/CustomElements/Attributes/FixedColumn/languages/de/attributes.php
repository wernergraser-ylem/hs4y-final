 ...
 * Attributes
 */
$GLOBALS['TL_LANG']['PCT_CUSTOMELEMENTS']['ATTRIBUTES']['fixedColumn'] = array('Statischer Feldwert','Dieses Attribut erstellt ein SQL Feld dessen Wert unveränderbar ist.');