...
class __TwigTemplate_ebbcb5f20d4dc6cf3eecf4e5fb46d46a extends Template
{
...
<div class=\"ce_video_background_inside contentwrap<?php if(\$this->field('padding_top_class')->value()): ?> <?php echo \$this->field('padding_top_class')->value(); ?><?php endif; ?><?php if(\$this->field('padding_bottom_class')->value()): ?> <?php echo \$this->field('padding_bottom_class')->value(); ?><?php endif; ?>\">";
    ...
    {
        return new Source("", "@pct_theme_templates/customelements/customelement_background_video_start.html5", "/var/www/vhosts/handyservice4you.at/update.handyservice4you.at/system/modules/pct_theme_templates/templates/customelements/customelement_background_video_start.html5");
    }
}
