...
class getMarkdownControllerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Y6Z.Nkq'] ?? $container->load('get_ServiceLocator_Y6Z_NkqService'))->withContext('Contao\\CoreBundle\\Controller\\ContentElement\\MarkdownController', $container));
