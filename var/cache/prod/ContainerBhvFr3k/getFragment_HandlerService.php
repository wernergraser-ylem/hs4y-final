...
class getFragment_HandlerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['fragment.handler'] = new \Contao\CoreBundle\Fragment\FragmentHandler(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'hinclude' => '?',
            'inline' => '?',
        ]), $a, false), $a, ($container->services['contao.fragment.registry'] ?? self::getContao_Fragment_RegistryService($container)), new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], []), false);
    }
}
