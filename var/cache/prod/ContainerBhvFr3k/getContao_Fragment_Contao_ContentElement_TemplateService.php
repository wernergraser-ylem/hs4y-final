...
class getContao_Fragment_Contao_ContentElement_TemplateService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = $container->load('get_ServiceLocator_GSfX_Ym_Contao_Fragment_Contao_ContentElement_TemplateService');

        $instance->setContainer($a);
        $instance->setFragmentOptions(['type' => 'template', 'category' => 'includes', 'template' => 'content_element/template', 'method' => NULL, 'renderer' => NULL, 'nestedFragments' => false, 'priority' => 0, 'debugController' => 'Contao\\CoreBundle\\Controller\\ContentElement\\TemplateController']);
        $instance->setContainer($a);
