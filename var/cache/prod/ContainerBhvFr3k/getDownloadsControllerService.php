...
class getDownloadsControllerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Qz8CPql'] ?? $container->load('get_ServiceLocator_Qz8CPqlService'))->withContext('Contao\\CoreBundle\\Controller\\ContentElement\\DownloadsController', $container));
