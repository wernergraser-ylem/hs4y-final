...
class getContao_Fragment_Contao_ContentElement_AccordionService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setFragmentOptions(['type' => 'accordion', 'category' => 'miscellaneous', 'template' => 'content_element/accordion', 'method' => NULL, 'renderer' => NULL, 'nestedFragments' => true, 'priority' => 0, 'debugController' => 'Contao\\CoreBundle\\Controller\\ContentElement\\AccordionController']);
        $instance->setContainer($a);
