...
class __TwigTemplate_6b864bcb6c8a7d8212c84dd64eaaab09 extends Template
{
    ...
    public function block_head(array $context, array $blocks = []): iterable
    {
        ...
        ";
        // line 5
        yield $this->env->getFunction('include')->getCallable()($this->env, $context, "@WebProfiler/Profiler/profiler.css.twig");
        yield "
        ";
        // line 6
        yield $this->env->getFunction('include')->getCallable()($this->env, $context, "@WebProfiler/Profiler/open.css.twig");
        yield "
    </style>
";
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        ";
        // line 12
        yield $this->env->getFunction('include')->getCallable()($this->env, $context, "@WebProfiler/Profiler/header.html.twig", [], false);
        yield "
        ...
        // line 18
        yield $this->env->getFilter('escape')->getCallable()($this->env, (isset($context["file"]) || array_key_exists("file", $context) ? $context["file"] : (function () { throw new RuntimeError('Variable "file" does not exist.', 18, $this->source); })()), "html", null, true);
        if ((0 < (isset($context["line"]) || array_key_exists("line", $context) ? $context["line"] : (function () { throw new RuntimeError('Variable "line" does not exist.', 18, $this->source); })()))) {
            yield " <small>line ";
            yield $this->env->getFilter('escape')->getCallable()($this->env, (isset($context["line"]) || array_key_exists("line", $context) ? $context["line"] : (function () { throw new RuntimeError('Variable "line" does not exist.', 18, $this->source); })()), "html", null, true);
            yield "</small>";
        }
        yield "</h1>
        ...
        yield "                    </div>
                ...
                <div id=\"sidebar\">
                    <dl class=\"file-metadata\">
                        ...
                        <dd>";
        // line 32
        yield $this->env->getFilter('escape')->getCallable()($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["file_info"]) || array_key_exists("file_info", $context) ? $context["file_info"] : (function () { throw new RuntimeError('Variable "file_info" does not exist.', 32, $this->source); })()), "pathname", [], "any", false, false, false, 32), "html", null, true);
        yield "</dd>
...
")) - 1);
        ...
        yield "                        <dd>
                            ";
        // line 41
        yield ((((isset($context["file_size_in_kb"]) || array_key_exists("file_size_in_kb", $context) ? $context["file_size_in_kb"] : (function () { throw new RuntimeError('Variable "file_size_in_kb" does not exist.', 41, $this->source); })()) < 1)) ? ($this->env->getFilter('escape')->getCallable()($this->env, (CoreExtension::getAttribute($this->env, $this->source, (isset($context["file_info"]) || array_key_exists("file_info", $context) ? $context["file_info"] : (function () { throw new RuntimeError('Variable "file_info" does not exist.', 41, $this->source); })()), "size", [], "any", false, false, false, 41) . " bytes"), "html", null, true)) : ($this->env->getFilter('escape')->getCallable()($this->env, ($this->extensions['Twig\Extension\CoreExtension']->formatNumber((isset($context["file_size_in_kb"]) || array_key_exists("file_size_in_kb", $context) ? $context["file_size_in_kb"] : (function () { throw new RuntimeError('Variable "file_size_in_kb" does not exist.', 41, $this->source); })()), 0) . " KB"), "html", null, true)));
        yield "
                            / ";
        // line 42
        yield $this->env->getFilter('escape')->getCallable()($this->env, (isset($context["file_num_lines"]) || array_key_exists("file_num_lines", $context) ? $context["file_num_lines"] : (function () { throw new RuntimeError('Variable "file_num_lines" does not exist.', 42, $this->source); })()), "html", null, true);
        yield " lines
                        </dd>
                    </dl>
        ...
        // line 46
        yield $this->env->getFilter('escape')->getCallable()($this->env, Twig\Extension\CoreExtension::constant("Symfony\\Component\\HttpKernel\\Kernel::VERSION"), "html", null, true);
...
{% endblock %}
", "@WebProfiler/Profiler/open.html.twig", "/var/www/vhosts/handyservice4you.at/update.handyservice4you.at/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/open.html.twig");
    }
}
