...
class __TwigTemplate_63de76e4af6af00e2df2e7d611e98bc1 extends Template
{
    ...
    <div class=\"sf-tabs\">
        ...
        foreach ($context['_seq'] as $context["dispatcherName"] => $context["dispatcherData"]) {
            ...
            yield "            <div class=\"tab\">
                <h3 class=\"tab-title\">";
            // line 16
            yield $this->env->getFilter('escape')->getCallable()($this->env, $context["dispatcherName"], "html", null, true);
            yield "</h3>
            ...
            if (Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["dispatcherData"], "called_listeners", [], "array", false, false, false, 18))) {
                ...
                // line 25
                yield $this->env->getFilter('escape')->getCallable()($this->env, Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["dispatcherData"], "called_listeners", [], "array", false, false, false, 25)), "html", null, true);
                yield "</span></h3>
                ...
                // line 33
                yield $this->env->getFilter('escape')->getCallable()($this->env, Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["dispatcherData"], "not_called_listeners", [], "array", false, false, false, 33)), "html", null, true);
                yield "</span></h3>
                                <div class=\"tab-content\">
                                    ";
                // line 35
                ...
                // line 53
                yield $this->env->getFilter('escape')->getCallable()($this->env, Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["dispatcherData"], "orphaned_events", [], "array", false, false, false, 53)), "html", null, true);
                yield "</span></h3>
                                <div class=\"tab-content\">
                                    ";
                // line 55
                if (Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["dispatcherData"], "orphaned_events", [], "array", false, false, false, 55))) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["event"]) {
                        ...
                        // line 76
                        yield $this->env->getFilter('escape')->getCallable()($this->env, $context["event"], "html", null, true);
                        yield "</td>
                                                    </tr>
                                                ";
                    }
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
                ...
                <tbody>
                    ...
                    // line 110
                    yield $this->env->getFilter('escape')->getCallable()($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["listener"], "event", [], "any", false, false, false, 110), "html", null, true);
                    yield "</th>
                    </tr>
            ...
            <tr>
                ...
                // line 117
                yield $this->env->getFilter('escape')->getCallable()($this->env, ((CoreExtension::getAttribute($this->env, $this->source, $context["listener"], "priority", [], "any", true, true, false, 117)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["listener"], "priority", [], "any", false, false, false, 117), "-")) : ("-")), "html", null, true);
                yield "</td>
                <td class=\"font-normal\">";
                // line 118
...
{% endmacro %}
", "@WebProfiler/Collector/events.html.twig", "/var/www/vhosts/handyservice4you.at/update.handyservice4you.at/vendor/symfony/web-profiler-bundle/Resources/views/Collector/events.html.twig");
    }
}
