...
class __TwigTemplate_ca695a4783e87135620882137029c8a1 extends Template
{
    ...
    public function block_head(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 4, $this->source); })()), "hasexception", [], "any", false, false, false, 4)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            ";
            // line 7
            yield $this->env->getFunction('include')->getCallable()($this->env, $context, "@WebProfiler/Collector/exception.css.twig");
            yield "
        </style>
    ";
        }
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/exception.html.twig", "/var/www/vhosts/handyservice4you.at/update.handyservice4you.at/vendor/symfony/web-profiler-bundle/Resources/views/Collector/exception.html.twig");
    }
}
