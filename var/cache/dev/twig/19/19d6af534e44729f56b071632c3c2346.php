...
/* @pct_theme_templates/customelements/customelement_pricetable4.html5 */
class __TwigTemplate_cbb424b00581537f8e4735dda7825dfd extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@pct_theme_templates/customelements/customelement_pricetable4.html5"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@pct_theme_templates/customelements/customelement_pricetable4.html5"));
...
\t
\t<div class=\"pricetable column col_3 no_gutter<?php if(\$this->field('highlight_1')->value()): ?> highlight<?php endif; ?>\">
\t\t
\t\t<div class=\"title\">
...
\t</div>
\t
\t<div class=\"pricetable column col_3 no_gutter<?php if(\$this->field('highlight_2')->value()): ?> highlight<?php endif; ?>\">
\t\t
\t\t<div class=\"title\">
...
\t</div>
\t
\t<div class=\"pricetable column col_3 no_gutter<?php if(\$this->field('highlight_3')->value()): ?> highlight<?php endif; ?>\">
\t\t
\t\t<div class=\"title\">
...
\t</div>
\t
\t<div class=\"pricetable column col_3 no_gutter<?php if(\$this->field('highlight_4')->value()): ?> highlight<?php endif; ?>\">
\t\t
\t\t<div class=\"title\">
\t\t\t<i class=\"<?php echo \$this->field('icon_4')->value(); ?>\"></i>
\t\t\t<?php echo \$this->field('title_4')->value(); ?>
\t\t</div>
\t\t
\t\t<div class=\"price\">
\t\t\t
\t\t\t<?php if(\$this->field('price_4')->value()): ?>
\t\t\t<div class=\"price-inside\">
\t\t\t\t<span class=\"currency\"><?php echo \$this->field('currency_4')->value(); ?></span>
\t\t\t\t<span class=\"font-size-l price-data\"><?php echo \$this->field('price_4')->value(); ?></span>
\t\t\t\t<span class=\"period\"><?php echo \$this->field('period_4')->value(); ?></span>
\t\t\t</div>
\t\t\t<?php endif; ?>
\t\t\t\t\t\t
\t\t\t<?php if(\$this->field('priceinfo_4')->value()): ?>
\t\t\t<div class=\"priceinfo\"><?php echo \$this->field('priceinfo_4')->value(); ?></div>
\t\t\t<?php endif; ?>
\t\t</div>
\t\t
\t\t<div class=\"contents\">
\t\t\t<?php echo \$this->field('contents_4')->value(); ?>
\t\t</div>
\t\t
\t\t<?php if(\$this->field('rating_4')->value()): ?>
\t\t<div class=\"rating\">
\t\t<?php if(\$this->field('rating_4')->value() =='star1'): ?><i class=\"fa fa-star\"></i><?php endif; ?>
\t\t<?php if(\$this->field('rating_4')->value() =='star2'): ?><i class=\"fa fa-star\"></i><i class=\"fa fa-star\"></i><?php endif; ?>
\t\t<?php if(\$this->field('rating_4')->value() =='star3'): ?><i class=\"fa fa-star\"></i><i class=\"fa fa-star\"></i><i class=\"fa fa-star\"></i><?php endif; ?>
\t\t<?php if(\$this->field('rating_4')->value() =='star4'): ?><i class=\"fa fa-star\"></i><i class=\"fa fa-star\"></i><i class=\"fa fa-star\"></i><i class=\"fa fa-star\"></i><?php endif; ?>
\t\t<?php if(\$this->field('rating_4')->value() =='star5'): ?><i class=\"fa fa-star\"></i><i class=\"fa fa-star\"></i><i class=\"fa fa-star\"></i><i class=\"fa fa-star\"></i><i class=\"fa fa-star\"></i><?php endif; ?>
\t\t</div>
\t\t<?php endif; ?>
\t\t
\t\t<?php if(\$this->field('link_4')->value()): ?>
\t\t<div class=\"ce_hyperlink\">
\t\t\t<?php echo \$this->field('link_4')->html(); ?>
\t\t</div>
\t\t<?php endif; ?>
\t\t
\t\t<?php if(\$this->field('highlight_text_4')->value()): ?><div class=\"hightlight_text\"><?php echo \$this->field('highlight_text_4')->value(); ?></div><?php endif; ?>
\t\t
\t</div>
    ...
    {
        return "@pct_theme_templates/customelements/customelement_pricetable4.html5";
    }
...
</div>\t", "@pct_theme_templates/customelements/customelement_pricetable4.html5", "/var/www/vhosts/handyservice4you.at/update.handyservice4you.at/system/modules/pct_theme_templates/templates/customelements/customelement_pricetable4.html5");
    }
}
